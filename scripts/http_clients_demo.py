...
async def demo_httpx():
    ...
    from app.fetch import close_http_client, fetch_with_retry
...
async def demo_aiohttp():
    ...
    from app.fetch_aiohttp import close_http_session, fetch_with_retry
...
async def demo_concurrent_requests():
    ...
    from app.fetch import fetch_with_retry as httpx_fetch
